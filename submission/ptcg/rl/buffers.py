...
FROZEN — docs/model.md requires the oracle block to freeze
now; the rest is sized with slack so phase-2 encoders fill in without a
layout change. Bump VERSION on any change; checkpoints are layout-bound.
...
# Vocab sizes (+16 appended-enum slack, docs/model.md; 0 = NULL)
N_CARDS = 1267 + 17
N_ATTACKS = 1556 + 17
N_ZONES = 16
N_OWNERS = 4
